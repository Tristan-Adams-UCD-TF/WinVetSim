...
sendSimctrData(void)
{
	...
	htmlReply += ",\n";
	_itoa_s(simmgr_shm->status.eyes.right_plr_exposed, buffer, 256, 10);
	makejson("right_plr_exposed", buffer);
	htmlReply += ",\n";
	_itoa_s(simmgr_shm->status.eyes.right_plr_consensual, buffer, 256, 10);
	makejson("right_plr_consensual", buffer);
	htmlReply += ",\n";
	_itoa_s(simmgr_shm->status.eyes.right_menace, buffer, 256, 10);
	makejson("right_menace", buffer);
	htmlReply += ",\n";
	_itoa_s(simmgr_shm->status.eyes.right_palpebral, buffer, 256, 10);
	makejson("right_palpebral", buffer);
	htmlReply += ",\n";
	_itoa_s(simmgr_shm->status.eyes.right_nystagmus, buffer, 256, 10);
	makejson("right_nystagmus", buffer);
	htmlReply += ",\n";
	_itoa_s(simmgr_shm->status.eyes.left_plr_exposed, buffer, 256, 10);
	makejson("left_plr_exposed", buffer);
	htmlReply += ",\n";
	_itoa_s(simmgr_shm->status.eyes.left_plr_consensual, buffer, 256, 10);
	makejson("left_plr_consensual", buffer);
	htmlReply += ",\n";
	_itoa_s(simmgr_shm->status.eyes.left_menace, buffer, 256, 10);
	makejson("left_menace", buffer);
	htmlReply += ",\n";
	_itoa_s(simmgr_shm->status.eyes.left_palpebral, buffer, 256, 10);
	makejson("left_palpebral", buffer);
	htmlReply += ",\n";
