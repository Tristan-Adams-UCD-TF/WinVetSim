...
sendSimctrData(void)
{
	...
	htmlReply += ",\n";
	_itoa_s(simmgr_shm->status.eyes.right_plr, buffer, 256, 10);
	makejson("right_plr", buffer);
	htmlReply += ",\n";
	...
	htmlReply += ",\n";
	_itoa_s(simmgr_shm->status.eyes.left_plr, buffer, 256, 10);
	makejson("left_plr", buffer);
	htmlReply += ",\n";
